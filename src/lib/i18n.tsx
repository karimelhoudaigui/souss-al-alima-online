      ...
      items: [
        {
          ...
          outcome: "Lecture corrigée, mémorisation structurée, Rasm wa Dabt",
          points: ["Mémorisation accompagnée", "Murājaʿa et correction individuelle", "Rasm wa Dabt selon la tradition marocaine"],
      ...
      items: [
        {
          ...
          outcome: "Corrected recitation, structured memorization, Rasm wa Dabt",
          points: ["Guided memorization", "Murājaʿa and individual correction", "Rasm wa Dabt according to Moroccan tradition"],
      ...
      items: [
        {
          ...
          outcome: "Lectura corregida, memorización estructurada, Rasm wa Dabt",
          points: ["Memorización acompañada", "Murājaʿa y corrección individual", "Rasm wa Dabt según la tradición marroquí"],
